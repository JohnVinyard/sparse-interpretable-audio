...
TODO: Consider a U-NET or Transformer encoder paired with a sparsity loss
...
During training, we repeatedly draw segments of audio from the Music Net dataset at random, with 
